...
var createWithTheme = function createWithTheme(ThemeProvider, ThemeContext) {
  return function withTheme(Comp, overrides) {
    var ThemedComponent =
    /*#__PURE__*/
    function (_React$Component) {
      ...
      function ThemedComponent() {
        ...
        _defineProperty(_assertThisInitialized(_this), "_merge", function (a, b, c) {
          ...
          result = c && result !== c ? (0, _deepmerge.default)(result, c) : result;
          _this._previous = {
            a: a,
            b: b,
            c: c,
      ...
      _proto.render = function render() {
        ...
        return React.createElement(ThemeContext.Consumer, null, function (theme) {
          return React.createElement(Comp, _extends({}, rest, {
            theme: _this2._merge(theme, rest.theme, overrides),
