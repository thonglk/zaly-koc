...
export default function AudioPlayer({ source }) {
    ...
    return (React.createElement(View, { style: styles.container },
        React.createElement(TouchableHighlight, { onPress: playSound, style: { marginRight: 8 } },
            React.createElement(AntDesign, { name: iconName, size: 24 })),
        React.createElement(Text, { style: { marginRight: 8 } },
            formatDuration(sliderPositionMillis || 0),
            " /",
            " ",
            formatDuration(durationMillis || 0)),
        React.createElement(Slider, { style: { flex: 1 }, minimumTrackTintColor: "#333", maximumTrackTintColor: "#000000", thumbTintColor: "black", minimumValue: 0, value: sliderPositionMillis, maximumValue: durationMillis, onValueChange: onSliderChange, onSlidingComplete: onSlidingComplete })));
}
