...
export const createElevationType = defaultValue => ({ ...ELEVATION_TYPE,
  defaultValue
});
...
export const createStaticBoolProp = (overrides = {}) => createBoolProp({
  group: GROUPS.basic,
  ...overrides
});
...
export const createStaticNumberProp = (overrides = {}) => createNumberProp({
  group: GROUPS.basic,
  ...overrides
});
...
export const createDirectionProp = (overrides = {}) => createTextEnumProp({
  label: "Direction",
...
export const createFieldNameProp = (overrides = {}) => ({ ...FIELD_NAME,
...
export const TEXT_INPUT_PROPS = {
  ...
  defaultValue: {
    group: GROUPS.basic,
    label: "Default Value",
    description: "The value that of the text-input initially, not a placeholder but the value that the textInput is taking in.",
    editable: true,
    required: false,
    defaultValue: null,
    formType: FORM_TYPES.string,
