...
import { GROUPS, COMPONENT_TYPES, FORM_TYPES, PROP_TYPES, FIELD_NAME, TEXT_INPUT_PROPS } from "@draftbit/types";
...
class TextField extends React.Component {
  ...
  render() {
    ...
    const inputStyles = applyStyles([styles.input, inputStyle, type === "solid" ? {
      marginHorizontal: 12
    } : {}], textStyles);
    const {
