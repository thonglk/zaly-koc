...
declare function Slider({ Icon, leftIcon, rightIcon, leftIconColor, rightIconColor, value, initialValue, minimumTrackTintColor, maximumTrackTintColor, thumbTintColor, minimumValue, maximumValue, tapToSeek, step, onValueChange, style, theme, ...rest }: Props): JSX.Element;
